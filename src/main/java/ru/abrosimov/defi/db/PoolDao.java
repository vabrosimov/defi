...
public class PoolDao {
    ...
    public List<String> deletePoolsOlderThanHours(long hours) {
        ...
        List<String> deletedPools = namedJdbcTemplate.query(sql, params,
                (rs, rowNum) -> rs.getString("pool")
        );

        log.debug("Delete pools older than {} hours from pool table:\nDeleted {} rows", hours, deletedPools.size());
